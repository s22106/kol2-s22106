    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicLabael", x => x.IdMusicLabel);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Album_MusicLabael_IdMusicLabel",
                        column: x => x.IdMusicLabel,
                        principalTable: "MusicLabael",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Thom", "Yorke", "Radiohead" });

            migrationBuilder.InsertData(
                table: "Album",
                columns: new[] { "IdAlbum", "AlbumName", "IdMusicLabel", "PublishDate" },
                values: new object[] { 1, "Kid A Mnesia", 1, new DateTime(2022, 6, 9, 13, 56, 45, 64, DateTimeKind.Local).AddTicks(9340) });

            migrationBuilder.InsertData(
                table: "Track",
                columns: new[] { "IdTrack", "Duration", "IdMusicAlbum", "TrackName" },
                values: new object[] { 1, 2.78f, 1, "Idioteque" });
